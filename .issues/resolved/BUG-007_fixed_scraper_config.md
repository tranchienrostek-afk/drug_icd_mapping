...
**Fix Method:** Full refactor of `config.py` schema (List of Dicts) and `core_drug.py`/`extractors.py` logic.
**Verification:** Verified with `debug_crawler_manual.py`. No crashes, correct navigation.
**Report:** [report_2026_01_07_BUG_007.md](file:///C:/Users/Admin/Desktop/drug_icd_mapping/.ai_planning/.implementation_rules/.ai_reports/2026-01/report_2026_01_07_BUG_007.md)
